...
def generate_launch_description():
    ...
    declare_simulator_cmd = DeclareLaunchArgument(
        "simulator", default_value="gazebo", description="The simulator to use (gazebo or gzserver)"
    )
    ...
    start_gazebo_cmd = ExecuteProcess(
        cmd=[simulator, "--verbose", "-s", "libgazebo_ros_factory.so", world], output="screen"
    )
